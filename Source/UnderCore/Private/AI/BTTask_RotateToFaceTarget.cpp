...
FString UBTTask_RotateToFaceTarget::GetStaticDescription() const
{
	...
	return FString::Printf(TEXT("Smoothly rotates to %s Key Until the angle precision : %s is reached"), *KeyDescription, *FString::SanitizeFloat(AnglePrecision));
}
...
bool UBTTask_RotateToFaceTarget::HasReachingAnglePrecision(APawn* QueryPawn, AActor* TargetActor)
{
